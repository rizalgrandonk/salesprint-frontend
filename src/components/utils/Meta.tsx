...
export default function Meta(seo: MetaProps) {
  ...
  const defaultSeo: SeoData = {
    ...
    keywords: "e-commerce, market, marketplace, jual beli, online, toko, inovasi",
    description:
  ...
  const fullSeo: SeoData = {
    ...defaultSeo,
    ...seo,
    keywords: `${seo.keywords ? seo.keywords + ", " : ""}${defaultSeo.keywords}`,
  };
  ...
  return (
    <Head>
      ...
      <link rel="mask-icon" href="/icons/safari-pinned-tab.svg?v=3" color="#515151" />
      <link rel="shortcut icon" href="/icons/favicon.ico?v=3" />
      <meta name="apple-mobile-web-app-title" content="Salesprint" />
      <meta name="application-name" content="Salesprint" />
