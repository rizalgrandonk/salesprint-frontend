      ...
      <div className="space-y-1">
        ...
        <div className="relative">
          ...
          <input
            ...
            id={props.id}
            className={clsx(
              "block w-full px-4 py-2 text-gray-700 placeholder-gray-400 bg-gray-50 border border-gray-400 rounded-md dark:placeholder-gray-500 dark:bg-gray-800 dark:text-gray-300 dark:border-gray-500 focus:border-primary dark:focus:border-primary focus:ring-primary focus:outline-none focus:ring focus:ring-opacity-40",
              { "pl-14": !!props.leftel }
            )}
          />
        </div>
