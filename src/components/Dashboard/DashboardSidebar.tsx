              ...
              <ul className="pb-2 space-y-2">
                ...
                <li>
                  ...
                  <ul id="dropdown-crud" className="space-y-2 py-2">
                    ...
                    {/* <li>
                <a href="/" className="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 {{ if eq $page_slug "users" }} bg-gray-100 dark:bg-gray-700 {{ end }}">Users</a>
              </li> */}
                  </ul>
                </li>
              </ul>
